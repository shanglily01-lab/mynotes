...
-- AlterTable
ALTER TABLE `Article` ALTER COLUMN `summaryPath` DROP DEFAULT;

-- AlterTable
ALTER TABLE `ExamQuestion` ALTER COLUMN `contentPath` DROP DEFAULT;

-- AlterTable
ALTER TABLE `PlanItem` ALTER COLUMN `contentPath` DROP DEFAULT;
