  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/middle" className="text-[#9a9590] hover:text-[#5a5550] text-[13px]">
          初中学习
        </Link>
      ...
      <div className="mb-8">
        ...
        <p className="text-[#5a5550] text-[15px] leading-relaxed">
          按学科查看 <span className="font-semibold text-[#003087]">2023-2025 年中考真题仿真练习</span>，
          以及 <span className="font-semibold text-[#8b1a2a]">2026 年中考预测试卷</span>。
        </p>
      </div>
      ...
      <div className="mt-10 pt-6 border-t border-[#e4e0d8] space-y-2">
        <p className="text-[12px] text-[#9a9590]">
          · 真题仿真：AI 参照 2023-2025 年深圳与全国主要省市中考的命题风格、难度、题型分布生成
        </p>
        <p className="text-[12px] text-[#9a9590]">
